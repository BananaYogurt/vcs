...
/**
 * created by 吴震煌 on 2017/3/6 13:30
 */
public class DiffMatchPatch {
     ...
     */
    public float Match_Threshold = 0.5f; //threshold 门槛
    /**
     ...
     * Other less paranoid languages(偏执) just use a three-element array.
     */
     ...
     * @return Linked List of Merge objects.
     */
    private LinkedList<Diff> diff_main(String text1, String text2, boolean checklines, long deadline){
        ...
        // Check for equality (speedup).检查是否是相同的一个文件
     ...
     * See Myers 1986 paper: An O(ND) Difference Algorithm and Its Variations(变化，差异).
     * @param text1 Old string to be diffed.
     * @param text2 New string to be diffed.
     * @param deadline Time at which to bail if not yet complete.
     * @return LinkedList of Merge objects.
     */
    protected LinkedList<Diff> diff_bisect(String text1, String text2, long deadline) {
        ...
        for (int d = 0; d < max_d; d++) {
            ...
            // Walk the reverse(相反) path one step.
        ...
        // Merge took too long and hit(击中) the deadline or
    ...
    /**
     * 将两个文本拆分成字符串列表。 将文本减少为一个散列的字符串，其中每个Unicode字符表示一行。
    ...
    /**
     * 将文本拆分为字符串列表。 将文本减少为一个散列的字符串，其中每个Unicode字符表示一行。
    ...
    private String diff_linesToCharsMunge(String text, List<String> lineArray,
        ...
        //String.indexOf()如何没有检索到，则返回-1
        while (lineEnd < text.length() - 1) {  //text.length != 0 ,text不为空

            //lineEnd 为从0到text换行的位置 如果没有换行 则说明lineEnd = -1
     ...
     * 将差异中的文本从一行哈希字符串转换为实际文本行。
     * @param diffs LinkedList of Merge objects.
     * @param lineArray List of unique strings.
     */
    ...
    /**
     * Determine the common prefix of two strings 确定两个字符串的公共前缀
     * @param text1 First string.
     * @param text2 Second string.
     * @return The number of characters common to the start of each string.每个字符串开头的公共字符数。
     */
    ...
    /**
     * Determine the common suffix of two strings 确定两个字符串的公共后缀
     * @param text1 First string.
     * @param text2 Second string.
    ...
    /**
     * 确定一个字符串的后缀是否是另一个字符串的前缀。
     * Determine if the suffix of one string is the prefix of another.
     * @param text1 First string.
     * @param text2 Second string.
     * @return The number of characters common to the end of the first
     *     string and the start of the second string.
     *     与第一个字符串的结尾和第二个字符串的开头相同的字符数。
     */
    protected int diff_commonOverlap(String text1, String text2) {
        // Cache the text lengths to prevent multiple calls. 缓存文本长度以防止多次调用
        int text1_length = text1.length();
        int text2_length = text2.length();
        ...
        // Truncate the longer string. 截断更长的字符串
    ...
    /**
     * semantically 语义  trivial 不重要的  eliminating 消除
    ...
    public void diff_cleanupSemantic(LinkedList<Diff> diffs) {
        ...
        // Normalize the diff. normalize 归一化
        if (changes) {
            diff_cleanupMerge(diffs);
        }
    ...
    public void diff_cleanupEfficiency(LinkedList<Diff> diffs) {
        ...
        Diff thisDiff = pointer.next();
        Diff safeDiff = thisDiff;  // The last Merge that is known to be unsplitable.
        while (thisDiff != null) {
            if (thisDiff.operation == Operation.EQUAL) {
                // Equality found.
     ...
     * loc是text1中的位置，计算并返回text2中的等效位置。
    ...
    /**
     * Convert a Merge list into a pretty HTML report.
     * @param diffs LinkedList of Merge objects.
        ...
        for (Diff aDiff : diffs) {
            switch (aDiff.operation) {
                ...
                case DELETE:
                    ...
                    break;
                case EQUAL:
                    // A deletion and an insertion is one substitution. 删除和插入是一个替换。
    ...
    /**
     * 将diff压缩到一个编码字符串中，该字符串描述将text1转换为text2所需的操作。
     ...
     * @param diffs Array of Merge objects.
     * @return Delta text.
     */
     ...
     * @return Array of Merge objects or null if invalid.
     ...
     * @param diffs Array of Merge objects for text1 to text2.
     * @return LinkedList of Patch objects.
     */
     ...
     * @param diffs Array of Merge objects for text1 to text2.
     * @return LinkedList of Patch objects.
     * @deprecated Prefer patch_make(String text1, LinkedList<Merge> diffs).
     */
    public LinkedList<Patch> patch_make(String text1, String text2,
                                        LinkedList<Diff> diffs) {
        return patch_make(text1, diffs);
    ...
    public static class Diff {
        ...
        /**
         * Display a human-readable version of this Merge.
         * @return text version.
         */
        public String toString() {
            String prettyText = this.text.replace('\n', '\u00b6');
            return "Merge(" + this.operation + ",\"" + prettyText + "\")";
        }

        /**
         * Create a numeric hash value for a Merge.
        ...
        /**
         * Is this Merge equivalent to another Merge?
         * @param obj Another Merge to compare against.
    ...
    public static class Patch {
        ...
        public String toString() {
            ...
            return unescapeForEncodeUriCompatibility(text.toString());
        }
    }
